...
% print('class_hists_ntsc','-dpng')

%not well detected: 15
...
Ifilled = imfill(ISigns,'holes');

figure;
subplot(1,4,1); imshow(I_orig);  title('Input image')
subplot(1,4,2); imshow(I);  title('NTSC')
subplot(1,4,3); imshow(Ifilled); title('filled holes')
subplot(1,4,4);imagesc(RGBLabels); axis image; title('Ground truth signs')
% % 
% figure;
% % Plot red hist
% subplot(3,1,1);
